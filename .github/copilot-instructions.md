...
- 确认源 URL 是当前可信上游：blackmatrix7、ddgksf2013、app2smile、Maasea、GOODBYEADS、ifflagged/Romeo、NSRingo、DualSubs、Auraflare、BiliUniverse（注意：KOP-XIAO 已下架、Sub-Store 已于 2026-09-11 移除，均不再是源）
- 新增上游须**锁定具体版本/commit**，禁止 `releases/latest/download` 等浮动引用（无法锁定亦无法验证，2026-09-11 供应链审计结论）
