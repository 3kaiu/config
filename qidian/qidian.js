[rewrite local]
# 精确匹配需要处理的三个API路径
^https?:\/\/(rmonitor\.qq\.com|magev6\.if\.qidian\.com)\/argus\/api\/v1\/video\/adv\/(finishWatch|mainPage) url script-response-body https://github.com/3kaiu/config/raw/main/qidian/universal_script.js
